...
public class ApplayoutDemoView extends VerticalLayout {
	...
	private Component[] createMenuItems() {
		...
		return new Component[] {
				...
				miToggleSettings, miHello, new MenuItem("About", "cloud", () -> showContent("About")), // icon as string
				...
				new MenuItem("SubMenu").setIcon("build").add(
						...
						new MenuItem("SubMenu").add(new MenuItem("Hello Again", () -> showContent("Hello Again!")))
								.add(new MenuItem("And Again", () -> showContent("And Again!")))),

				new MenuSeparator("Separator"),

				new MenuItem("Item 1"), new MenuItem("Item 2"), new MenuItem("Item 3"), new MenuItem("Item 4"),
				new MenuItem("Item 5"), new MenuItem("Item 6"),

				new MenuSeparator(),

				new MenuItem("Item 7"), new MenuItem("Item 8"), new MenuItem("Item 9"), new MenuItem("Item 10"),
				new MenuItem("Item 11"), new MenuItem("Item 12") };
	}
